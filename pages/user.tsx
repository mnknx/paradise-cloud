  ...
  return <PageUserSideLayout path={'/user'} className={className}>
    ...
    </div>
    {
      !isCrust && <MCard>
        ...
        <div className="text font-sans-regular">Log in with Paradiseum Wallet and Deposit CRU to get Premium. </div>
        <div className={'btns mbtns'}>
          <Btn content="Download Paradiseum Wallet" onClick={_onClickDownCrustWallet} />
        </div>
      </MCard>}
    {
      showDeposit && <MCard>
        ...
        <div className={'btns mbtns'}>
          ...
          <a href="/docs/Users" target="_blank">How to deposit?</a>
        </div>
      </MCard>}
    {
      showClaim && <MCard>
        ...
        <div className={'btns mbtns'}>
          ...
          <a href="/docs/Users" target="_blank">Learn more about Redeem Rules.</a>
        </div>
