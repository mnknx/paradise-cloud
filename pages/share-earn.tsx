...
function Index(props: Props) {
  ...
  return <PageUserSideLayout path="/share-earn" className={className}>
    <div className="share-and-earn">
      <div className="text">
        <span>Share</span> Paradiseum Cloud with <br />
        your friends,<br />
    ...
    <PixelBoard className="earn_item">
      ...
      <div className="left">
        <InviteBonusTitle>
          Invite friends to Paradiseum<br />
      ...
      <DetailedRules target={'_blank'} href={locationUrl('/docs/ShareandEarn/#invite_bonus')}>Detailed Rules</DetailedRules>
    </PixelBoard>
    ...
    <PixelBoard className="earn_item">
      ...
      <DetailedRules target={'_blank'} href={locationUrl('/docs/ShareandEarn/#lucky_newbie')}>Detailed Rules</DetailedRules>
    </PixelBoard>

    {
      showGrandDraw && <PixelBoard className="earn_item">
            ...
            My Ticket Number: {
              isPremiumUser ?
                ...
                <span style={{ color: '#333333', fontSize: 20, verticalAlign: 'middle' }}>
                  - Get <span style={{ color: '#995ff7', cursor: 'pointer' }} onClick={_clickGetPremium}>Premium User</span> to join the game.
                </span>
            }
          </div>
          {
        ...
        <DetailedRules target={'_blank'} href={locationUrl('/docs/ShareandEarn/#grand_draw')}>Detailed Rules</DetailedRules>
      </PixelBoard>}
    ...
    <PixelBoard className="earn_item">
      ...
      <DetailedRules target={'_blank'} href={locationUrl('/docs/ShareandEarn/#claim_rewards')}>Learn More</DetailedRules>
    </PixelBoard>
  </PageUserSideLayout>
}
